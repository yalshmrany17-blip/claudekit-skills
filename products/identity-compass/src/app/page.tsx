...
const STEPS = [
  ...
  { n: "٣", t: "احصل على التقرير الكامل", d: "ملف نمطك، قواك المميزة، سلوكك وتحدياتك وعلاقاتك ومسارك، قيمك، وخطة تسعين يوماً مخصصة، مع قراءة عميقة يكتبها الذكاء الاصطناعي من إجاباتك." },
];
...
const PAID = [
  ...
  "مبدأ هويتك في سطر",
  "خطة التسعين يوماً مخصصة مع تقويم أسبوعي",
...
const FAQ = [
  ...
  ["هل أحتاج التقرير الكامل؟", "النتيجة المجانية تخبرك أين أنت. التقرير الكامل يخبرك ماذا تفعل: ملف نمطك، قواك، قيمك، حدودك، مسارك، وخطة تسعين يوماً مخصصة."],
