...
const STEPS = [
  { n: "١", t: "أجب عن 140 سؤالاً", d: "نحو خمس وعشرين دقيقة: علامات الخلل، وضوح الذات، سمات الشخصية، نمطك، القيم، نقاط القوة، الدوافع السلبية، بيئة العمل، وعشر إجابات بكلماتك." },
  { n: "٢", t: "اقرأ نتيجتك فوراً", d: "مؤشر وضوح الهوية، نمطك بنسبه الأربع، حالة هويتك، مرحلتك العمرية، وسماتك الخمس. مجاناً وبلا تسجيل بطاقة." },
  { n: "٣", t: "اقرأ التقرير الكامل", d: "ملف نمطك، قواك المميزة، سلوكك وتحدياتك وعلاقاتك ومسارك، قيمك، وقراءة عميقة يكتبها الذكاء الاصطناعي من إجاباتك." },
  { n: "٤", t: "اصنع هويتك ونفّذها", d: "تكتب قيمك ورسالتك وتموضعك وحدودك بمساعدة اقتراحات من نتائجك، تخرج بوثيقة هوية، ثم تتابع خطة التسعين يوماً أسبوعاً بأسبوع." },
];

const FREE = ["مؤشر وضوح الهوية من 100", "نمط شخصيتك من ستة عشر بنسبه الأربع", "علامات الخلل التسع", "وضوح مفهوم الذات", "حالة الهوية: استكشاف والتزام", "مرحلتك عند إريكسون", "سمات الشخصية الخمس"];
const PAID = [
  "ملف نمطك الكامل: قواه وتحدياته وعلاقاته ومساره",
  "قواك الخمس المميزة وكيف تستخدمها",
  "سلوكك اليومي، تحدياتك، علاقاتك، عملك ومسارك",
...
const SCIENCE = [
  ...
  ["الأنماط الأربعة", "طاقتك وانتباهك وقرارك وأسلوبك بنسب على أربعة أبعاد ونمط من ستة عشر، تُقرأ مع سماتك لا بديلاً عنها."],
  ["نقاط القوة الشخصية", "اثنتا عشرة قوة، وخمس مميزة تبني عليها؛ استخدام القوى المميزة يرفع الرضا أكثر من إصلاح الضعف."],
...
const FAQ = [
  ...
  ["هل أحتاج التقرير الكامل؟", "النتيجة المجانية تخبرك أين أنت. التقرير الكامل يخبرك ماذا تفعل، ثم يفتح لك مرحلة البناء التي تكتب فيها هويتك بنفسك ومتابعة التسعين يوماً."],
  ["هل أنماط الشخصية علمية؟", "الأنماط الأربعة لغة مفيدة للوصف لكنها أقل ثباتاً علمياً من السمات الخمس، لذلك نعرضها بنسب لا بصندوق مغلق، ونقرأها مع بقية نتائجك."],
    ...
    <div className="mx-auto max-w-5xl px-5">
      <section className="grid items-center gap-10 py-14 md:grid-cols-[minmax(0,1fr)_260px]">
        <div>
          ...
          <h1 className="display mt-2 text-5xl leading-tight md:text-6xl">اعرف من أنت، ثم اصنع هويتك.</h1>
          <p className="mt-5 max-w-prose text-lg text-muted">
            {SITE.items} سؤالاً مبنية على أبحاث علم النفس تخبرك أين أنت، ثم مرحلة بناء تكتب فيها هويتك بنفسك: قيمك، رسالتك، تموضعك، حدودك، وخطة تسعين يوماً تنفذها وتتابعها.
          </p>
      ...
      <section id="pricing" className="border-t border-line py-14">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          ...
          <div className="card border-accent">
            ...
            <p className="mt-2 text-muted">التقرير الكامل، وقراءة الشركة، ومرحلة البناء، ومتابعة التسعين يوماً.</p>
