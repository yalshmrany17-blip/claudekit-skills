...
export default async function BuildPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: rep }, { data: ident }] = await Promise.all([
  ...
  return <IdentityBuilder assessmentId={id} userId={user.id} result={result} answers={answers} synthesis={synthesis} initial={initial} name={name} />;
}
